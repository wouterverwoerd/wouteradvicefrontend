                    ...
                    {ideas && ideas.map(idea =>
                        <tr key={idea.id}>
                            ...
                            <td style={{ whiteSpace: 'nowrap' }}>
                                ...
                                <div style={{ margin: '5px' }}><a href={`https://recipe-box-282464207064.asia-southeast1.run.app/?add=1&desc=${idea.description}`} className="btn btn-sm btn-primary mr-1" target="_blank">Recipe</a></div>
